...
function VerifyEmailChange() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-xl shadow-2xl border border-gray-800 p-8 max-w-md w-full text-center">
        {status === 'verifying' && (
          <>
        ...
        {status === 'success' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-white">Email Updated!</h2>
            <p className="text-gray-400 mt-2">{message}</p>
            <button
              onClick={() => navigate('/')}
              className="mt-6 bg-green-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-green-500 transition-colors"
            >
              Go to BandChat
            </button>
          </>
