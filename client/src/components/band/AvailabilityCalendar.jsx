      ...
      <div className="flex-shrink-0 p-4 border-b border-[var(--color-border)]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex bg-[var(--color-bg-tertiary)] rounded overflow-hidden">
              <button
                ...
                className={`px-3 py-2 text-sm ${view === 'personal' ? 'bg-slack-purple text-white' : 'text-[var(--color-text-secondary)]'}`}
              >
                My Availability
              </button>
              <button
                onClick={() => setView('team')}
                className={`px-3 py-2 text-sm ${view === 'team' ? 'bg-slack-purple text-white' : 'text-[var(--color-text-secondary)]'}`}
              >
                Team View
              </button>
            </div>
        ...
        <div className="flex items-center gap-4 mt-3 text-sm">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[var(--color-text-muted)]">Maybe</span>
          </div>
          <div className="flex items-center gap-1">
            ...
            <div className="space-y-2">
              ...
              {getMyStatus(selectedDate) !== 'UNKNOWN' && (
                <button
                  ...
                  disabled={saving}
                  className="w-full flex items-center gap-3 p-3 rounded bg-[var(--color-bg-tertiary)] hover:bg-[var(--color-bg-hover)] text-[var(--color-text-secondary)] disabled:opacity-50"
                >
