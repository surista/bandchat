...
const SVG_TEMPLATES = {
  ...
  'electric-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><path d="M44 8 L46 6 L48 8 L46 10 Z" fill="#e67e22"/><line x1="44" y1="10" x2="36" y2="18" stroke="#aaa" stroke-width="2"/><line x1="46" y1="8" x2="38" y2="16" stroke="#aaa" stroke-width="2"/><path d="M36 18 Q32 20 30 24 Q28 28 28 32 Q24 34 22 38 Q20 42 22 46 Q24 50 28 50 Q32 50 34 46 Q36 42 34 38 Q34 34 36 30 Q40 28 42 24 Q44 20 40 16 Z" fill="#e67e22" opacity="0.9"/><circle cx="28" cy="40" r="3" fill="none" stroke="#b35900" stroke-width="1.5"/><line x1="26" y1="44" x2="22" y2="52" stroke="#aaa" stroke-width="2"/><line x1="30" y1="44" x2="34" y2="52" stroke="#aaa" stroke-width="2"/><rect x="30" y="26" width="6" height="2" rx="1" fill="#b35900"/></svg>`,
  'acoustic-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><line x1="44" y1="6" x2="36" y2="18" stroke="#aaa" stroke-width="2.5"/><rect x="42" y="4" width="6" height="4" rx="1" fill="#8b6940"/><circle cx="44" cy="6" r="1" fill="#aaa"/><circle cx="46" cy="8" r="1" fill="#aaa"/><circle cx="48" cy="6" r="1" fill="#aaa"/><path d="M36 18 Q32 20 30 24 Q26 28 24 34 Q20 38 20 42 Q20 48 26 50 Q32 52 36 48 Q40 44 38 38 Q38 32 40 26 Q42 22 40 18 Z" fill="#c8a25c" stroke="#8b6940" stroke-width="1.5"/><ellipse cx="30" cy="40" rx="5" ry="4" fill="#3a2a10"/><circle cx="30" cy="40" r="1.5" fill="#c8a25c"/><line x1="28" y1="24" x2="28" y2="50" stroke="#aaa" stroke-width="0.5" opacity="0.5"/><line x1="30" y1="24" x2="30" y2="50" stroke="#aaa" stroke-width="0.5" opacity="0.5"/><line x1="32" y1="24" x2="32" y2="50" stroke="#aaa" stroke-width="0.5" opacity="0.5"/></svg>`,
  ...
  'bass-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><rect x="42" y="4" width="8" height="6" rx="1" fill="#3498db"/><circle cx="44" cy="6" r="1" fill="#aaa"/><circle cx="48" cy="6" r="1" fill="#aaa"/><line x1="44" y1="10" x2="34" y2="22" stroke="#aaa" stroke-width="2.5"/><path d="M34 22 Q30 24 28 28 Q26 32 26 36 Q22 38 20 42 Q18 46 20 50 Q22 54 26 54 Q30 54 32 50 Q34 46 32 42 Q32 38 34 34 Q38 30 38 26 Q38 22 36 20 Z" fill="#3498db" opacity="0.9"/><circle cx="26" cy="44" r="3" fill="none" stroke="#1a6fa0" stroke-width="1.5"/><rect x="28" y="30" width="6" height="2" rx="1" fill="#1a6fa0"/><line x1="24" y1="48" x2="20" y2="56" stroke="#aaa" stroke-width="2"/><line x1="28" y1="48" x2="32" y2="56" stroke="#aaa" stroke-width="2"/></svg>`,
