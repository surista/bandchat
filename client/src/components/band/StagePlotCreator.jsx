...
const SVG_TEMPLATES = {
  ...
  'electric-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><rect x="28" y="2" width="8" height="7" rx="2" fill="#5c3310"/><circle cx="26" cy="3.5" r="1.3" fill="#bbb"/><circle cx="26" cy="6.5" r="1.3" fill="#bbb"/><circle cx="38" cy="3.5" r="1.3" fill="#bbb"/><circle cx="38" cy="6.5" r="1.3" fill="#bbb"/><rect x="30" y="7" width="4" height="24" rx="1" fill="#a0693a"/><circle cx="32" cy="14" r="0.8" fill="#ddd"/><circle cx="32" cy="20" r="0.8" fill="#ddd"/><circle cx="32" cy="26" r="0.8" fill="#ddd"/><path d="M24 31 Q16 33 14 40 Q13 48 20 53 Q26 57 32 57 Q38 57 44 53 Q51 48 50 40 Q48 33 40 31 L37 27 L27 27 Z" fill="#e67e22" stroke="#c0570a" stroke-width="1.2"/><rect x="24" y="36" width="16" height="3" rx="1.5" fill="#333" stroke="#555" stroke-width="0.5"/><rect x="24" y="44" width="16" height="3" rx="1.5" fill="#333" stroke="#555" stroke-width="0.5"/><rect x="28" y="50" width="8" height="2" rx="1" fill="#aaa"/><circle cx="21" cy="50" r="2" fill="#444" stroke="#666" stroke-width="0.5"/></svg>`,
  'acoustic-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><rect x="29" y="2" width="6" height="6" rx="2" fill="#5c3310"/><circle cx="27" cy="3.5" r="1.2" fill="#bbb"/><circle cx="27" cy="6" r="1.2" fill="#bbb"/><circle cx="37" cy="3.5" r="1.2" fill="#bbb"/><circle cx="37" cy="6" r="1.2" fill="#bbb"/><rect x="30" y="6" width="4" height="22" rx="1" fill="#8b6914"/><rect x="28" y="6" width="8" height="3" rx="1" fill="#6b5010"/><circle cx="32" cy="14" r="0.7" fill="#ddd"/><circle cx="32" cy="20" r="0.7" fill="#ddd"/><ellipse cx="32" cy="30" rx="10" ry="6" fill="#d4a04a" stroke="#8b6914" stroke-width="1.2"/><ellipse cx="32" cy="44" rx="14" ry="12" fill="#d4a04a" stroke="#8b6914" stroke-width="1.2"/><circle cx="32" cy="42" r="5" fill="#8b6914"/><rect x="28" y="50" width="8" height="2" rx="0.5" fill="#5c3310"/><line x1="30" y1="9" x2="30" y2="52" stroke="#bbb" stroke-width="0.3"/><line x1="32" y1="9" x2="32" y2="52" stroke="#bbb" stroke-width="0.3"/><line x1="34" y1="9" x2="34" y2="52" stroke="#bbb" stroke-width="0.3"/></svg>`,
  ...
  'bass-guitar': `<svg viewBox="0 0 64 64" width="48" height="48"><rect x="28" y="1" width="8" height="8" rx="2" fill="#0f4c75"/><circle cx="26" cy="3" r="1.5" fill="#bbb"/><circle cx="26" cy="7" r="1.5" fill="#bbb"/><circle cx="38" cy="3" r="1.5" fill="#bbb"/><circle cx="38" cy="7" r="1.5" fill="#bbb"/><rect x="30" y="7" width="4" height="26" rx="1" fill="#1a6fa8"/><circle cx="32" cy="14" r="0.8" fill="#ddd"/><circle cx="32" cy="22" r="0.8" fill="#ddd"/><circle cx="32" cy="28" r="0.8" fill="#ddd"/><path d="M24 33 Q16 35 14 42 Q13 50 20 55 Q26 59 32 59 Q38 59 44 55 Q51 50 50 42 Q48 35 40 33 L37 29 L27 29 Z" fill="#3498db" stroke="#1a6fa8" stroke-width="1.2"/><rect x="23" y="38" width="18" height="3" rx="1.5" fill="#0f4c75" stroke="#1a6fa8" stroke-width="0.5"/><rect x="23" y="46" width="18" height="3" rx="1.5" fill="#0f4c75" stroke="#1a6fa8" stroke-width="0.5"/><rect x="28" y="52" width="8" height="2" rx="1" fill="#aaa"/><line x1="30" y1="9" x2="30" y2="54" stroke="#bbb" stroke-width="0.4"/><line x1="32" y1="9" x2="32" y2="54" stroke="#bbb" stroke-width="0.4"/><line x1="34" y1="9" x2="34" y2="54" stroke="#bbb" stroke-width="0.4"/></svg>`,
