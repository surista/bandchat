 ...
 *
 * Public-facing "show page" for a completed gig the band has explicitly
 * marked public (`Gig.isPublic = true`). No auth required.
 *
...
router.get('/:gigId', async (req, res) => {
  try {
    ...
    const setlistItems = gig.setlists.flatMap((gs) =>
