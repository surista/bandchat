      ...
      <Modal visible={showActions} transparent animationType="slide">
        <TouchableOpacity style={styles.actionOverlay} activeOpacity={1} onPress={() => { setShowActions(false); setSelectedTx(null); }}>
          <View style={[styles.actionSheet, { backgroundColor: colors.modalBg }]}>
            ...
            <TouchableOpacity style={styles.actionItem} onPress={handleDeleteTransaction}>
              <Text style={[styles.actionText, { color: '#ef4444' }]}>Delete</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.actionItem, styles.actionCancel]} onPress={() => { setShowActions(false); setSelectedTx(null); }}>
      ...
      <Modal visible={showSettings} transparent animationType="fade">
        <View style={styles.settingsOverlay}>
          <View style={[styles.settingsContent, { backgroundColor: colors.modalBg }]}>
            ...
            />
            <View style={styles.formActions}>
              <TouchableOpacity style={[styles.formButton, { backgroundColor: colors.bgTertiary }]} onPress={() => setShowSettings(false)} disabled={savingSettings}>
                <Text style={[styles.formButtonText, { color: colors.textPrimary }]}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.formButton, { backgroundColor: colors.primary }]} onPress={handleSaveSettings} disabled={savingSettings}>
